...
def prediction(data, processed_list, input_builder, model):
    ...
    if id in processed_list:
        return None
    if model is None:
        prediction, retrieve_time = input_builder.direct_answer(data)
        return {
            "id": id,
            "question": question,
    ...
    input, retrieve_time, peak_memory = input_builder.process_input(data)
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "--data_path", type=str, default="Benyucong"
    )
    ...
    argparser.add_argument("--threshold", type=float, default=0.7)
    ...
    # argparser.add_argument("--kb", action="store_true")
